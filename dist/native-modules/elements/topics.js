...
var Topics = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.projectId)
                            return [2];
                        return [4, BcfServices.topic.getTopics(this.projectId)];
                    case 1:
                        _a.sent();
    ...
    Topics.prototype.clickTopic = function (topic, event) {
        ...
        var customEvent = DOM.createCustomEvent('topic', { detail: topic, bubbles: true });
    ...
    Topics = __decorate([
        ...
        __metadata("design:paramtypes", [AureliaBcf, HTMLElement, EventAggregator])
    ], Topics);
    return Topics;
}());
export { Topics };
