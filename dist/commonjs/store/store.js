...
var store = function () {
    var getAll = aurelia_framework_1.Container.instance.getAll(aurelia_store_1.Store);
    if (getAll.length === 0) {
        console.warn('BCF Store can only be accessed once the Aurelia Store plugin has been configured');
        return undefined;
    }
    return aurelia_framework_1.Container.instance.get(aurelia_store_1.Store);
};
exports.store = store;
var dispatcher = function (action) {
    ...
    return function (data) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4, (_a = store()).dispatch.apply(_a, __spreadArrays([action, data], params))];
                case 1:
                    _b.sent();
                    return [2, data];
            }
