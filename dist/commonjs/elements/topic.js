...
var Topic = (function () {
                ...
                switch (_a.label) {
                    case 0:
                        if (!this.projectId || !this.topicId)
                            return [2];
                        return [4, index_1.BcfServices.topic.getTopic(this.projectId, this.topicId)];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.projectId || !this.topicId)
                            return [2];
                        return [4, index_1.BcfServices.viewpoint.getViewpoints(this.projectId, this.topicId)];
                    case 1:
                        _a.sent();
                        this.eventAggregator.publish('bcf:fetched-viewpoints', { projectId: this.projectId, topicId: this.topicId });
                        return [4, index_1.BcfServices.comment.getComments(this.projectId, this.topicId)];
                    case 2:
                        _a.sent();
    ...
    __decorate([
        aurelia_framework_1.computedFrom('projectId', 'topicId', 'bcf.state.bcf.comments', 'bcf.state.bcf.comments.length', 'bcf.state.bcf.viewpoints.length'),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [])
    ], Topic.prototype, "comments", null);
    Topic = __decorate([
        aurelia_framework_1.customElement('bcf-topic'),
        aurelia_framework_1.inject(aurelia_bcf_1.AureliaBcf, aurelia_event_aggregator_1.EventAggregator),
        __metadata("design:paramtypes", [aurelia_bcf_1.AureliaBcf, aurelia_event_aggregator_1.EventAggregator])
    ], Topic);
    return Topic;
}());
exports.Topic = Topic;
