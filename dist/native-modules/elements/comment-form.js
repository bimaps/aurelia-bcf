...
var CommentForm = (function () {
    ...
    CommentForm.prototype.setInstanceFromApi = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, BcfServices.comment.getComment(this.projectId, this.topicId, this.commentId)];
                    case 1:
                        comment = _a.sent();
                        if (!comment) {
    ...
    CommentForm.prototype.setViewpointInstanceFromApi = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, BcfServices.viewpoint.getViewpoint(this.projectId, this.topicId, this.instance.viewpoint_guid)];
                    case 1:
                        viewpoint = _a.sent();
                        if (!viewpoint) {
    ...
    CommentForm.prototype.dispatchViewpoint = function () {
        var customEvent = DOM.createCustomEvent('viewpoint', { detail: this.viewpointInstance, bubbles: true });
    ...
    CommentForm = __decorate([
        ...
        __metadata("design:paramtypes", [AureliaBcf, Object, HTMLElement])
    ], CommentForm);
    return CommentForm;
}());
export { CommentForm };
